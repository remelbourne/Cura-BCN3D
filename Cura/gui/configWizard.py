...
class MachineSelectPage(InfoPage):
    ...
    def OnBCN3DSigmaSelect(self,e):
        wx.wizard.WizardPageSimple.Chain(self, self.GetParent().bcn3dsigmaReadyPage)

    def OnBCN3DPlusSelect(self,e):
        wx.wizard.WizardPageSimple.Chain(self, self.GetParent().bcn3dplusReadyPage)
    ...
    def StoreData(self):
        ...
        if self.BCN3DSigmaRadio.GetValue() or self.BCN3DPlusRadio.GetValue() or self.BCN3DRRadio or self.Ultimaker2Radio.GetValue() or self.Ultimaker2GoRadio.GetValue() or self.Ultimaker2ExtRadio.GetValue() or self.UltimakerRadio.GetValue() or self.UltimakerOPRadio.GetValue():
            if self.BCN3DSigmaRadio.GetValue():
            ...
            if self.BCN3DPlusRadio.GetValue():
                ...
                profile.putMachineSetting('machine_name', 'BCN3D +')
                profile.putMachineSetting('machine_type', 'BCN3DPlus')
                profile.putMachineSetting('has_heated_bed', 'True')
                profile.putProfileSetting('nozzle_size', '0.4')
                profile.putMachineSetting('gcode_flavor', 'RepRap (Marlin/Sprinter)')
            if self.BCN3DRRadio.GetValue():
                profile.putMachineSetting('machine_width', '170')
                profile.putMachineSetting('machine_depth', '170')
                profile.putMachineSetting('machine_height', '180')
                profile.putMachineSetting('machine_name', 'BCN3D R')
                profile.putMachineSetting('machine_type', 'BCN3DR')
                profile.putMachineSetting('machine_center_is_zero', 'True')
                profile.putMachineSetting('machine_shape', 'Circular')
                profile.putMachineSetting('has_heated_bed', 'True')
                profile.putProfileSetting('nozzle_size', '0.4')
                profile.putProfileSetting('extruder_amount', '1')
                profile.putMachineSetting('gcode_flavor', 'RepRap (Marlin/Sprinter)')
